<?php
	...
	'database_host_description' => 'Si esta utilizando Ushahidi en su propia computadora, esta dirección deberá ser "localhost". Si lo está utilizando en un servidor externo, deberá obtener esta información del proovedor del servidor',
	...
	'enable' => 'Habilitar',
	'error' => array(
		'connection' => '<strong>Oops!</strong>, No pudimos conectarnos con la base de datos en el servidor con las credenciales dadas. Por favor asegúrate que son correctas.',
		'db_name' => 'Pon favor inrese el <strong>nombre</strong> de la base de datos.',
		'host' => 'Por favor ingrese el <strong>host</strong> del servidor de la base de datos.',
		'load_db_tpl' => '<strong>Oops!</strong> Necesito el archivo llamado <code>database.template.php</code> para trabajar desde allí. Por favor asegúrate que este archivo está en la carpeta <code>application/config/</code>.',
		'site_name' => 'Por favor asegúrate de ingresar un <strong>nombre del Sitio</strong>.',
		'unable_to_write_end' => ' file. Por favor cambia los permisos de este archivo a escribibles (777) <p>Aquí unas instrucciones para cambiar permisos:</p><ul><li><a href="http://www.washington.edu/computing/unix/permissions.html">Unix/Linux</a></li><li><a href="http://support.microsoft.com/kb/308419">Windows</a></li></ul>',
	...
	'error_summary' => 'Esta es una lista de los errores encontrados',
	...
	'index' => array(
		...
		'advanced_installation_description' => 'Obtiene toda la información para la instalación por medio de un proceso de cinco pasos, incluyendo servidor, mapas, nombre del sitio y detalles de contacto',
