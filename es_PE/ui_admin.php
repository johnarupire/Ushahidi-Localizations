<?php
	...
	'password_reset_message_line_3' => 'Para cambiar su contraseña, por favor seleccione el enlace siguiente (o cópielo y péguelo en la barra de de direcciones de su navegador).',
	...
	'stats' => 'Estadísticas',
	'stats_collection_error' => 'Recolección estadística fallida! O nuestro servidor de estadísticas está caído o hay algo mal en la configuración de tu Ushahidi. Trata nuevamente en un momento para saber si el servidor está en línea y funcionando. Para resetear manualmente tus estadísticas, modifica stat_id (set to null) y stat_key (set to 0) en la tabla de configuración de tu base de datos. CUIDADO!: Podrías perder acceso a tus estadísticas si haces esto!',
